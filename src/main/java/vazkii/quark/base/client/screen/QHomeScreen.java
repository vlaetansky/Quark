...
public class QHomeScreen extends QScreen {
	...
	protected void init() {
		...
		addButton(new Button(left, vStart, bWidth, 20, new TranslationTextComponent("General Settings"), this::returnToParent));
		addButton(new Button(left + bWidth + pad, vStart, bWidth, 20, new TranslationTextComponent("Import Config"), this::returnToParent));
