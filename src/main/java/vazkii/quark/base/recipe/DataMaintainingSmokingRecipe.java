...
public class DataMaintainingSmokingRecipe extends SmokingRecipe {
	...
	public static class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<DataMaintainingSmokingRecipe> {

		public Serializer() {
			setRegistryName("quark:maintaining_smoking");
		}
		...
		public DataMaintainingSmokingRecipe fromJson(@Nonnull ResourceLocation recipeId, @Nonnull JsonObject json) {
			...
			return new DataMaintainingSmokingRecipe((AbstractCookingRecipe) parent, pullFrom);
		}
		...
		public DataMaintainingSmokingRecipe fromNetwork(@Nonnull ResourceLocation recipeId, @Nonnull FriendlyByteBuf buffer) {
			...
			RecipeSerializer<?> serializer = ForgeRegistries.RECIPE_SERIALIZERS.getValue(new ResourceLocation("minecraft:smoking"));
			if (serializer == null)
