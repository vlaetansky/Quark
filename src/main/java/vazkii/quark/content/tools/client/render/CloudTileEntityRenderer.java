...
public class CloudTileEntityRenderer implements BlockEntityRenderer<CloudBlockEntity> {

	public CloudTileEntityRenderer(BlockEntityRendererProvider.Context context) {
		// NO-OP
	}
