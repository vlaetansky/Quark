...
public class CrabModel extends EntityModel<CrabEntity> {
	...
	public CrabModel() {
		...
		group.setPos(0.0F, 0.0F, 0.0F);

		this.leftLeg4 = new ModelPart(this, 0, 19);
		this.leftLeg4.mirror = true;
		this.leftLeg4.setPos(3.0F, 20.0F, -1.0F);
		...
		this.leftLeg3.setPos(3.0F, 20.0F, 0.0F);
		...
		this.rightEye.setPos(0.0F, 0.0F, 0.0F);
		...
		this.rightLeg4.setPos(-3.0F, 20.0F, -1.0F);
		...
		this.rightClaw.setPos(-3.0F, 20.0F, -4.0F);
		...
		this.leftLeg1.setPos(3.0F, 20.0F, 2.0F);
		...
		this.rightLeg2.setPos(-3.0F, 20.0F, 0.9F);
		...
		this.leftClaw.setPos(3.0F, 20.0F, -4.0F);
		...
		this.rightLeg1.setPos(-3.0F, 20.0F, 2.0F);
		...
		this.leftEye.setPos(0.0F, 0.0F, 0.0F);
		...
		this.leftLeg2.setPos(3.0F, 20.0F, 0.9F);
		...
		this.rightLeg3.setPos(-3.0F, 20.0F, 0.0F);
