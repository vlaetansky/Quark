...
//			shiba.setMouthItem(shiba.fetching.getArrowStack());
	...
	public boolean shouldExecute() {
		AbstractArrowEntity fetching = shiba.getFetching();
		return shiba.getMouthItem().isEmpty() && fetching != null && fetching.isAlive() && fetching.world == shiba.world && fetching.pickupStatus == PickupStatus.ALLOWED;
	}
